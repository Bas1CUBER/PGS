...
$imgBaseName = 'Office for Strategy Management';
$uploadMsg = '';
$uploadSuccess = false;
...
$pageTitle = 'Office for Strategy Management';
$pageStyles = <<<'STYLES'
    ...
    <main>
        <div class="container page-container">
            <div class="mb-4 text-center">
                <h3 class="fw-bold text-dark mb-1">Office for Strategy Management</h3>
                <div class="text-muted">Organization</div>
            </div>
            <div class="image-wrap">
                <?php if (file_exists($imgPath)): ?>
                    <img src="<?= h($imgUrl) ?>" alt="Office for Strategy Management" class="osm-image" id="osmImage">
                <?php else: ?>
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content bg-dark">
                ...
                <div class="modal-body p-0 d-flex align-items-center justify-content-center">
                    <?php if (file_exists($imgPath)): ?>
                        <img src="<?= h($imgUrl) ?>" alt="Office for Strategy Management" class="fit-viewport">
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php
$pageScripts = '<script src="' . asset('js/pages/office_for_strategy_management_1.js') . '"></script>';
?>
  </div>
