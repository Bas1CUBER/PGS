...
<?php $pgsPage = ['role' => $role, 'years' => $years, 'trainingsByYear' => $trainingsByYear]; ?><script>window.PGS.page = <?= json_encode($pgsPage) ?>;</script><script src="<?= asset('js/pages/training_roadmap_certified_tot_1.js') ?>"></script>
</body>
</html>
