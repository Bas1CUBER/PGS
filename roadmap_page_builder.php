...
<?php $pgsPage = ['itemId' => $itemId, 'isAdmin' => $isAdmin, 'csrf' => csrf_token()]; ?><script>window.PGS.page = <?= json_encode($pgsPage) ?>;</script><script src="<?= asset('js/pages/roadmap_page_builder_1.js') ?>"></script>
  </div>
