...
<script>
    document.querySelectorAll('.edit-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            document.getElementById('edit-objective').value = btn.getAttribute('data-objective');
            document.getElementById('edit-target_audience').value = btn.getAttribute('data-target_audience');
            document.getElementById('edit-message').value = btn.getAttribute('data-message');
            document.getElementById('edit-channel').value = btn.getAttribute('data-channel');
            document.getElementById('edit-timeframe').value = btn.getAttribute('data-timeframe');
            document.getElementById('edit-requirements').value = btn.getAttribute('data-requirements');
            document.getElementById('edit-responsible_person').value = btn.getAttribute('data-responsible_person');
            document.getElementById('edit-status').value = btn.getAttribute('data-status') || 'Not Accomplished/Started';
            const modal = new bootstrap.Modal(document.getElementById('editEntryModal'));
            modal.show();
        });
    });

    const deleteEntryTopForm = document.getElementById('deleteEntryTopForm');
    if (deleteEntryTopForm) {
        deleteEntryTopForm.addEventListener('submit', (e) => {
            e.preventDefault();
            const selected = deleteEntryTopForm.querySelector('select[name="id"]');
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) deleteEntryTopForm.submit();
            });
        });
    }
</script>
