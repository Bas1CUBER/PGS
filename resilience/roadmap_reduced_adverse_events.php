...
<?php $pageStyles = '<link rel="stylesheet" href="' . asset('css/pages/resilience_roadmap_reduced_adverse_events.css') . '">';
?>
...
<?php $pgsPage = ['labels' => $labels, 'd2024' => $d2024, 'd2025' => $d2025, 'd2026' => $d2026, 'd2027' => $d2027]; ?><script>window.PGS.page = <?= json_encode($pgsPage) ?>;</script><script src="<?= asset('js/pages/resilience_roadmap_reduced_adverse_events_1.js') ?>"></script>
</body>
</html>
