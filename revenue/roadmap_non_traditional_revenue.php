...
<?php $pageStyles = '<link rel="stylesheet" href="' . asset('css/pages/revenue_roadmap_non_traditional_revenue.css') . '">';
?>
...
<?php $pgsPage = ['chartLabels' => $chartLabels, 'c2024' => $c2024, 'c2025' => $c2025, 'c2026' => $c2026, 'c2027' => $c2027]; ?><script>window.PGS.page = <?= json_encode($pgsPage) ?>;</script><script src="<?= asset('js/pages/revenue_roadmap_non_traditional_revenue_1.js') ?>"></script>
</body>
</html>
