...
<?php $pageStyles = page_css('css/pages/revenue_roadmap_hospital_income.css');
?>
...
<?php $pgsPage = ['labels' => $labels, 'd2024' => $d2024, 'd2025' => $d2025, 'd2026' => $d2026, 'd2027' => $d2027]; ?><script>window.PGS.page = <?= json_encode($pgsPage) ?>;</script><script src="<?= asset('js/pages/revenue_roadmap_hospital_income_1.js') ?>"></script>
</body>
</html>
