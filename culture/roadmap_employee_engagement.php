...
<body>
  ...
  <?php $pgsPage = ['chartTrendLabels' => $chartTrendLabels, 'chartTrendActualData' => $chartTrendActualData, 'chartTrendTargetData' => $chartTrendTargetData, 'role' => $role]; ?><script>window.PGS.page = <?= json_encode($pgsPage) ?>;</script><script src="<?= asset('js/pages/culture_roadmap_employee_engagement_1.js') ?>"></script>
