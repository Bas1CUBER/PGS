...
<body>
  ...
  <?php $pgsPage = ['canInput' => (bool)$canInput, 'role' => $role]; ?><script>window.PGS.page = <?= json_encode($pgsPage) ?>;</script><script src="<?= asset('js/pages/research_roadmap_outputs_1.js') ?>"></script>
</body>
</html>
