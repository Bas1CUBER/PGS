...
$pageStyles = page_css('css/pages/about_pgs_pathway.css');
...
<div class="container">
  ...
  <?php $pgsPage = ['panels' => $panels, 'role' => $role]; ?><script>window.PGS.page = <?= json_encode($pgsPage) ?>;</script><script src="<?= asset('js/pages/about_pgs_pathway_1.js') ?>"></script>
  </div>
