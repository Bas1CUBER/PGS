...
<head>
  ...
  <title>Governance Scorecard: Decreased Turnaround Time for Patient Records Retrieval</title>
  ...
  <style>
    ...
    .timer-sm { font-size: 1.6rem; font-weight: 800; letter-spacing: .04em; text-align:center; color:#111; border: 3px solid #111; padding:.35rem .6rem; border-radius:.4rem; display:inline-block; min-width: 8ch; background:#fff; }
  </style>
</head>
...
<script>
  ...
  document.querySelectorAll('.js-edit').forEach(btn => {
    btn.addEventListener('click', async (e) => {
      ...
      const payload = {
        id: tr.dataset.id,
        registry_no: cells[0].textContent.trim(),
        ...
        returned_date: cells[5].textContent.trim(),
        returned_time: cells[6].textContent.trim(),
        retrieval_time: cells[7].textContent.trim(),
      };
      const html = `
        <div class="row g-2">
          <div class="col-md-4"><label class="form-label">Registry No.</label><input class="form-control form-control-sm" id="e_registry" value="${payload.registry_no}"></div>
          ...
          <div class="col-md-4"><label class="form-label">Returned Date</label><input type="date" class="form-control form-control-sm" id="e_rtdate" value="${payload.returned_date}"></div>
          <div class="col-md-4"><label class="form-label">Returned Time</label><input type="time" step="1" class="form-control form-control-sm" id="e_rttime" value="${payload.returned_time}"></div>
          <div class="col-md-4"><label class="form-label">Retrieval Time (minutes)</label><input type="text" class="form-control form-control-sm" id="e_rt" value="${payload.retrieval_time}"></div>
        </div>
      `;
      ...
      fd.append('registry_no', document.getElementById('e_registry').value);
      ...
      fd.append('returned_date', document.getElementById('e_rtdate').value);
      fd.append('returned_time', document.getElementById('e_rttime').value);
