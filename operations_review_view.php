...
$filePath = __DIR__ . '/uploads/operations_review/' . $file['filename'];
...
<body>
  ...
  <div class="page-wrapper">
    ...
    <div class="header">
        ...
        <div>
            <a href="uploads/operations_review/<?= h($file['filename']) ?>" 
               class="btn btn-light btn-sm me-2" download>
                <i data-lucide="download" class="me-1"></i> Download
            </a>
            <a href="operations_review_new.php" class="btn btn-outline-light btn-sm">
                <i data-lucide="arrow-left" class="me-1"></i> Back
            </a>
        </div>
    </div>
    <iframe src="uploads/operations_review/<?= h($file['filename']) ?>" 
            class="pdf-viewer">
        <p>Your browser does not support PDF viewing. 
           <a href="uploads/operations_review/<?= h($file['filename']) ?>" download>
               Download the PDF
           </a>
        </p>
    </iframe>
    ...
    <div class="container">
        <div class="header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-2">
                        <i data-lucide="file-image" class="me-2"></i>
                        <?= h($file['original_name']) ?>
                    </h4>
                ...
                <div>
                    ...
                    <a href="operations_review_new.php" class="btn btn-outline-secondary btn-sm">
                        <i data-lucide="arrow-left" class="me-1"></i> Back
                    </a>
                </div>
            </div>
        ...
        <div class="image-container">
            <img src="uploads/operations_review/<?= h($file['filename']) ?>" 
