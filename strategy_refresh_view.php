...
$filePath = __DIR__ . '/uploads/strategy_refresh/' . $file['filename'];
...
<body>
  ...
  <div class="page-wrapper">
    ...
    <div class="header">
        ...
        <div>
            <a href="uploads/strategy_refresh/<?= h($file['filename']) ?>" 
               class="btn btn-light btn-sm me-2" download>
                <i data-lucide="download" class="me-1"></i> Download
            </a>
            <a href="strategy_refresh.php" class="btn btn-outline-light btn-sm">
                <i data-lucide="arrow-left" class="me-1"></i> Back
            </a>
        </div>
    </div>
    <iframe src="uploads/strategy_refresh/<?= h($file['filename']) ?>" 
            class="pdf-viewer">
        <p>Your browser does not support PDF viewing. 
           <a href="uploads/strategy_refresh/<?= h($file['filename']) ?>" download>
               Download the PDF
           </a>
        </p>
    </iframe>
  ...
  <div class="page-wrapper">
    ...
    <div class="container">
        <div class="header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="strategy_refresh.php" class="btn btn-outline-secondary btn-sm">
                        <i data-lucide="arrow-left" class="me-1"></i> Back
                    </a>
                </div>
            </div>
        ...
        <div class="image-container">
            <img src="uploads/strategy_refresh/<?= h($file['filename']) ?>" 
                 alt="<?= h($file['title']) ?>">
        </div>
    </div>
      </div>
